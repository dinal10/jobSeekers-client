...
export default function ApplyCard({ applications }) {
  return (
    <div className="w-full h-full max-w-md shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <div className="w-full h-full group bg-black p-4 job-card rounded-xl">
